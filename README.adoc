...
Design-wise, the project is an amalgamation of older efforts and desires.
...
Windows is cross-compiled in CI:
 ...
 $ sh -e msys2-configure.sh
 $ cmake -DCMAKE_TOOLCHAIN_FILE=submodules/liberty/cmake/toolchains/MinGW-w64-x64.cmake \
   -DCMAKE_BUILD_TYPE=Release -B build
 $ WINEPATH=$PWD/ucrt64/bin cmake --build build -- package
